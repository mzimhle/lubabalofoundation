  ...
  <div id="content">
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/administration/events/" title="Jobs">Event</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
    <h2>Manage Event</h2>
	<a href="/administration/events/details.php" title="Click to Add a new Event" class="blue_button fr mrg_bot_10"><span style="float:right;">Add a new Event</span></a>  <br /> 
		...
		<div class="content_table">
			<table id="dataTable" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td align="left"><a href="/administration/events/details.php?code={$item.event_code}">{$item.event_name}</a></td>
				<td align="left">{$item.event_date}</td>
