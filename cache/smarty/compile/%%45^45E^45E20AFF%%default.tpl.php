<?php /* Smarty version 2.6.20, created on 2015-07-21 04:20:29
         compiled from contacts/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'contacts/default.tpl', 58, false),)), $this); ?>
<!DOCTYPE html>
...
<section>
    ...
    <div class="whitebox boxes cf">
    	<div class="wrap">
			...
			<?php if (isset ( $this->_tpl_vars['success'] )): ?><span style="color: #7F0023;font-size: 15px;">Your enquiry has been successfully submitted, we will get back to you as soon as possible.</span><br /><br /><?php endif; ?>
            <form id="detailsForm" name="detailsForm" method="post" target="" action="/contacts/">
            <div class="formbox">
                <label>Name<?php if (isset ( $this->_tpl_vars['errorArray']['enquiry_name'] )): ?><span style="color: #7F0023;font-size: 14px;"> - <?php echo $this->_tpl_vars['errorArray']['enquiry_name']; ?>
</span><?php endif; ?></label><br /><input type="text" name="enquiry_name" id="enquiry_name" value="" class="shad" />
                <label>Email Address<?php if (isset ( $this->_tpl_vars['errorArray']['enquiry_email'] )): ?><span style="color: #7F0023;font-size: 14px;"> - <?php echo $this->_tpl_vars['errorArray']['enquiry_email']; ?>
</span><?php endif; ?></label><br /><input type="text" name="enquiry_email" id="enquiry_email" value="" class="shad" />                				
            </div>
            <div class="formbox2">
                <label>Surname<?php if (isset ( $this->_tpl_vars['errorArray']['enquiry_surname'] )): ?><span style="color: #7F0023;font-size: 14px;"> - <?php echo $this->_tpl_vars['errorArray']['enquiry_surname']; ?>
</span><?php endif; ?></label><br /><input type="text" name="enquiry_surname" id="enquiry_surname" value="" class="shad" />
                <label>Phone Number<span style="color: #7F0023;font-size: 14px;"> - <?php echo ((is_array($_tmp=@$this->_tpl_vars['errorArray']['enquiry_cellphone'])) ? $this->_run_mod_handler('default', true, $_tmp, "e.g. 0812596541") : smarty_modifier_default($_tmp, "e.g. 0812596541")); ?>
</span></label><br /><input type="text" name="enquiry_cellphone" id="enquiry_cellphone" value="" class="shad" />
            </div>
            <label>Enquiry Message<?php if (isset ( $this->_tpl_vars['errorArray']['enquiry_message'] )): ?><span style="color: #7F0023;font-size: 14px;"> - <?php echo $this->_tpl_vars['errorArray']['enquiry_message']; ?>
</span><?php endif; ?></label><br />
